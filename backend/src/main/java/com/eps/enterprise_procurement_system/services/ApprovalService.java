...
public class ApprovalService {
        ...
        public List<PurchaseRequisitionResponseDTO> getManagerRequisitions(
                ...
                List<PurchaseRequisition> requisitions = approvalRepo
                                .findRequisitionsByApprovalTypeAndStatusAndDepartment(
...
public List<PurchaseRequisitionResponseDTO> getProcurementRequisitions(String status) {
