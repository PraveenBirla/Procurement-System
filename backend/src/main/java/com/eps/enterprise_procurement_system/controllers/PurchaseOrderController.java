...
public class PurchaseOrderController {
    ...
    public ResponseEntity<ApiResponse<List<PurchaseOrderResponseDTO>>> getSupplierOrders() {

        return ResponseEntity.ok(new ApiResponse<>(purchaseOrderService.getSupplierOrders()));
    }
